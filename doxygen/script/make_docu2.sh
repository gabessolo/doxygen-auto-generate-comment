...
DOXYGEN_INPUT_DIRECTORY=$CURDIR/../../firmware/src/serverd
...
OUTPUT_AUTO_GENERATE_DIR=$DOXYGEN_OUTPUT_AUTO_GENERATE_DIR OUTPUT_DIRECTORY=$DOXYGEN_OUTPUT_DIRECTORY \
	INPUT=$DOXYGEN_INPUT_DIRECTORY  OUTPUT_UNDOCUMENTED_DIR=$DOXYGEN_OUTPUT_UNDOCUMENTED_DIR  doxygen  $CONFIG_FILE 
